...
console.log('Don\'t forget to style!');
...
CreateStore.prototype.cookiesPerHr = function() {
  for (var i = 0; i < hrsOfOperation.length -1; i++) {
    ...
    var ulItemElement = document.getElementById(this.storeName);
    ...
    listItemElement.textContent = hrsOfOperation[i] + ': ' + randomCookies;
...
var firstAndPike = new CreateStore('firstAndPike', 23, 65, 6.3);
var seaTacAirport = new CreateStore('seaTacAirport', 3, 24, 1.2);
var seattleCenter = new CreateStore('seattleCenter', 11, 38, 3.7);
var capitolHill = new CreateStore('capitolHill', 20, 38, 2.3);
